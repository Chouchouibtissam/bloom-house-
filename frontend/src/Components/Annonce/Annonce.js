...
const Annonce = ({annonce}) => {
  ...
  return (
    <div className='mb-8 bg-white shadow-1 p-5 rounded-lg w-full max-w-[352px] mx-auto cursor-pointer hover:shadow-2xl transition'>
      ...
      <div className='mt-4 shadow-1 p-1 rounded-lg w-10  mx-auto cursor-pointer hover:shadow-2xl transition bg-blue-500'>
      <div className='mb-1 flex flex-col items-center' >
      <div className='flex items-center text-white '>
        <div className='text-[20px]'>
        <Link to="/"><BiTrash /></Link> 
        </div>
      </div>
    </div>
    </div>
